...
for (size_t i=0; i< loopFunctions.Nests.size(); i++){ 
     ...
     // required: leaving this 0.0 will draw the nest inside of the floor
	    ...
	    DrawCircle(nest_3d, CQuaternion(), loopFunctions.NestRadius/1.2, CColor::GRAY50);
...
void MPFA_qt_user_functions::DrawBranches() {
    ...
    CRay3 targetRay = CRay3(CVector3(7.5, 7.5, 0.05), CVector3(5.0, 5.0, 0.05));
	RayList0.push_back(targetRay);
	
	targetRay = CRay3(CVector3(2.7, 2.4, 0.05), CVector3(5.0, 5.0, 0.05));
	RayList0.push_back(targetRay);	
	
	targetRay = CRay3(CVector3(7.5, 2.5, 0.05), CVector3(5.0, 5.0, 0.05));
	RayList0.push_back(targetRay);
	
	targetRay = CRay3(CVector3(2.5, 7.5, 0.05), CVector3(5.0, 5.0, 0.05));
	RayList0.push_back(targetRay);
	...
	targetRay = CRay3(CVector3(7.5, -7.5, 0.05), CVector3(5.0, -5.0, 0.05));
	RayList0.push_back(targetRay);
	...
	targetRay = CRay3(CVector3(5, 5, 0.05), CVector3(0, 0, 0.05));
