...
fileNames = ["random_dynamic_MPFA_n16_r16_tag512_10by10_iAntTagData.txt",
"random_dynamic_MPFA_n16_r20_tag512_10by10_iAntTagData.txt",
"random_dynamic_MPFA_n16_r24_tag512_10by10_iAntTagData.txt",
"random_dynamic_MPFA_n16_r28_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r32_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r48_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r64_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r80_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r96_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r112_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [16.0, 20.0, 24.0, 28.0, 32.0, 48.0, 64.0, 80.0, 96.0, 112.0]
#pdb.set_trace()
...
ind = [4, np.log2(20), np.log2(24), np.log2(28), 5, np.log2(48), 6, np.log2(80), np.log2(96), np.log2(112)]
...
axarr.set_xlim(3.5, 7)
#axarr.set_xticks(ind+width)
axarr.set_xticklabels( ('4', 'log2(20)', 'log2(24)', 'log2(28)', '5', 'log2(48)', '6', 'log2(80)', 'log2(96)', 'log2(112)'), fontsize=12)
axarr.set_xlabel('Number of robots', fontsize=20)
