...
def linearReg(handle, X, Y, color, outputFile):
    ...
    outputFile.write("slope \t\t intercept \t\t\t r_value**2 \t\t\t p value stderr")
    outputFile.write(str(slope)+'\t\t'+str(intercept)+'\t\t\t'+str(r_value**2)+'\t\t\t'+str(p_value)+'\t\t'+str(stderr)+'\r')
    return slope, intercept


fileNames = ["random_dynamic_MPFA_n4_r4_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r8_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r12_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r16_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r18_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r20_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n4_r24_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [4.0, 8.0, 12.0, 16.0, 18.0, 20.0, 24.0]
#pdb.set_trace()
...
ind = [2, 3, np.log2(12), 4, np.log2(18), np.log2(20), np.log2(24)]
...
axarr.set_xlim(1.5, 5)
#axarr.set_xticks(ind+width)
axarr.set_xticklabels( ('2', '3', 'log2(12)', '4', 'log2(18)', 'log2(20)', 'log2(24)'), fontsize=12)
axarr.set_xlabel('Number of robots', fontsize=20)
axarr.set_yticks(np.arange(12, 28, 2))
