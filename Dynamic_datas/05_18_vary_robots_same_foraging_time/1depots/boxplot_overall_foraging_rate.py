...
fileNames = ["random_dynamic_MPFA_n1_r6_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n1_r12_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n1_r16_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n1_r20_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n1_r24_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [6.0,12.0, 16.0, 20.0, 24.0]
#pdb.set_trace()
...
ind = [np.log2(6), np.log2(12), np.log2(16), np.log2(20), np.log2(24)]
...
axarr.set_xticklabels( ('log2(6)', 'log2(12)', 'log2(16)', 'log2(20)', 'log2(24)'), fontsize=12)
axarr.set_xlabel('Log2 of number of robots', fontsize=20)
axarr.set_yticks(np.arange(8, 18, 2))
