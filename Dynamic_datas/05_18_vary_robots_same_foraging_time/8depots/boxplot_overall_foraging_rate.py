...
fileNames = ["random_dynamic_MPFA_n8_r20_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n8_r24_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n8_r26_tag512_10by10_iAntTagData.txt","random_dynamic_MPFA_n8_r28_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n8_r32_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n8_r36_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [20.0, 24.0, 26.0, 28.0, 32.0, 36.0]
#pdb.set_trace()
...
axarr.set_xlim(-0.5, 6)
#axarr.set_xticks(ind+width)
axarr.set_xticklabels( ('log2(20)', 'log2(24)', 'log(26)', 'log(28)', '5', 'log(36)'), fontsize=12)
axarr.set_xlabel('Number of robots', fontsize=20)
axarr.set_yticks(np.arange(12, 22, 2))
