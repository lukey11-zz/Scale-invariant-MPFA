...
fileNames = ["random_dynamic_MPFA_n6_r20_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n6_r22_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n6_r24_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n6_r26_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [20.0, 22.0, 24.0, 26.0]
#pdb.set_trace()
...
axarr.set_xlim(-0.5, 4)
#axarr.set_xticks(ind+width)
axarr.set_xticklabels( ('20.0', '22.0', '24.0', '26.0'), fontsize=18)
