...
fileNames = ["without_cluster_dynamic_MPFA_n4_r24_tag256_10by10_iAntTagData.txt", "without_cluster_dynamic_MPFA_n4_r48_tag256_20by20_iAntTagData.txt", "without_cluster_dynamic_MPFA_n4_r72_tag256_30by30_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)


fileNames = ["with_cluster_dynamic_MPFA_n4_r24_tag256_10by10_iAntTagData.txt", "with_cluster_dynamic_MPFA_n4_r48_tag256_20by20_iAntTagData.txt", "with_cluster_dynamic_MPFA_n4_r72_tag256_30by30_iAntTagData.txt"]
...
rect= axarr.boxplot(Y, notch=True, positions =ind+2*width, widths=0.1)
plt.setp(rect['boxes'], color=colors[1])


slope, intercept = linearReg(axarr, ind+2*width, np.array(Y).mean(axis=1), colors[1], outputFile) 

#axarr.plot(ind, (ind+2*width)*slope+intercept, colors[1])
