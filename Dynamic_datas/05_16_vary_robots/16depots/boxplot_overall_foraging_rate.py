...
fileNames = ["random_dynamic_MPFA_n16_r16_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r32_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r48_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r64_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r80_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r96_tag512_10by10_iAntTagData.txt", "random_dynamic_MPFA_n16_r112_tag512_10by10_iAntTagData.txt"]
without_comm_datas = get_multiple_data(fileNames)

avg_forage =[]
num_robots = [16.0, 32.0, 48.0, 64.0, 80.0, 96.0, 112.0]
#pdb.set_trace()
...
axarr.set_xlim(-0.5, 7)
#axarr.set_xticks(ind+width)
axarr.set_xticklabels( ('16', '32', '48', '64', '80', '96', '112'), fontsize=18)
axarr.set_xlabel('Number of robots', fontsize=20)
axarr.set_yticks(np.arange(0, 2, 1))
